...
WrongAnswerScreen.prototype.setUp = function()
{
	...
	var sContent = '<div id="game_screen_logo_4" class="gameScreenLogo"></div><div id= "imgHolder_In_Revealing" class="gameImg"></div><div class="questionTxt"><p>No. You are wrong!</p></div><div class="explnDiv"><p>'+config.questionSet[this.mApplication.nQuestionIndex].solution+'</p></div><div id="wrong_next_question" class="nextQues"><img src="'+sb+'"/></div>'	
