...
SplashScreen.prototype.setUp = function() {
	...
	var mObj = this.mApplication.arrImagesTrack['Introduction_25-years']
	document.getElementById('splashScreen').appendChild(mObj);
	mObj.style.marginTop = "50px";
	mObj.style.marginLeft = "55px";
